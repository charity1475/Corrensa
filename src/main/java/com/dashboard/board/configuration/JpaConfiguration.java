package com.dashboard.board.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.dashboard.board.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.dashboard.board.model" });
